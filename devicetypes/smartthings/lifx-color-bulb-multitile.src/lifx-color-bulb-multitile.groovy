 ...
 */
metadata {
	definition (name: "LIFX Color Bulb (multiTile)", namespace: "smartthings", author: "LIFX") {
		capability "Actuator"
	...
	tiles (scale: 2){
		multiAttributeTile(name:"switch", type: "lighting", width: 6, height: 4, canChangeIcon: true){
			tileAttribute ("device.switch", key: "PRIMARY_CONTROL") {
            	attributeState "unreachable", label: "?", action:"refresh.refresh", icon:"st.switches.light.off", backgroundColor:"#666666"
            ...
            tileAttribute ("device.colorTemperature", key: "SECONDARY_CONTROL") {
				attributeState "colorTemp", label: '${currentValue}K'
            }
